...
export function BrokerageSettings({ role }: BrokerageSettingsProps) {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      setLoading(true);
      // Both owner and manager currently use the same endpoint
      // Can be extended in the future if different endpoints are needed
